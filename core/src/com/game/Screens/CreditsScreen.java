...
public class CreditsScreen implements Screen {
    ...
    public void show() {
        ...
        tCreditsMusic1 = new TextField("", textFieldStyleManager.returnTextFieldStyle(textFieldStyle));
    ...
    public void render(float delta) {
        ...
        for(int i=0; i<Math.round(Gdx.graphics.getHeight()); i++) {
            if (i%200==0) {
                ...
                //Ewentualnie +10 pikseli albo coś, jeśli ma chwilę poczekąć przed zmianę screena
    ...
    private void initSettingsUI(){
        ...
        table_credits = new Table(images);
